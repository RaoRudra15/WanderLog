  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (
        ...
        setError("An unexpected error occured. Please try agaian.");
      }
    }
  };
  return (
    <div className="h-screen bg-cyan-50 overflow-hidden relative">
      ...
      <div className="login-ui-box bg-cyan-200 -bottom-40 -right-1/12" />

      <div className="container h-screen flex items-center  justify-center px-40 mx-auto">
